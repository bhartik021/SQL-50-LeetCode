...
Note that the price is per unit. <br />
...
Write a solution to select the product id, year, quantity, and price for the first year of every product sold. <br />

Return the resulting table in any order. <br />
